...
class SortDemoTest {
    ...
    */
    ...
    public void SameNumber() {
        ...
        assertTrue(data.getArray()[0].key == data2.getArray()[0].key );
        assertTrue(data.getArray()[1].key == data2.getArray()[1].key );
        assertTrue(data.getArray()[2].key == data2.getArray()[2].key );
    }
